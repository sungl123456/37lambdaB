...
def main(params, net_params):
    ...
    for epoch in range(params['max_epoch']):
        start = time.time()
        model, epoch_train_loss, epoch_train_metrics  = train_epoch_frag_VLE4(model, optimizer, scaling_T,
        ...
        epoch_val_loss, epoch_val_metrics = evaluate_frag_VLE4(model, scaling_T, fetched_data.val_iter, 
    ...
    _, epoch_train_metrics = evaluate_frag_VLE4(model, scaling_T,fetched_data.train_iter,
                                                fetched_data.train_batched_origin_graph_list_comp1,
                                                fetched_data.train_batched_origin_graph_list_comp2,
                                                fetched_data.train_batched_frag_graph_list_comp1,
                                                fetched_data.train_batched_frag_graph_list_comp2,
    ...
    _, epoch_val_metrics = evaluate_frag_VLE4(model,scaling_T,fetched_data.val_iter, 
                                                                                ...
                                                                                fetched_data.val_smiles_list_comp1,fetched_data.val_smiles_list_comp2,
                                                                                n_param,params['lam_T'])
    _, epoch_test_metrics = evaluate_frag_VLE4(model,scaling_T,fetched_data.test_iter, 
                                                                                ...
                                                                                fetched_data.test_T,
                                                                                fetched_data.test_smiles_list_comp1,fetched_data.test_smiles_list_comp2,n_param,params['lam_T'])
    _, epoch_raw_metrics = evaluate_frag_VLE4(model,scaling_T,fetched_data.all_iter, 
                                                                                ...
                                                                                fetched_data.all_x1,
                                                                                fetched_data.all_T,fetched_data.all_smiles_list_comp1,fetched_data.all_smiles_list_comp2,n_param,params['lam_T'])
...
def func_to_be_opt_MO(hidden_dim, depth, layers, decay, dropout, init_lr, lr_reduce_factor, lam_T):
