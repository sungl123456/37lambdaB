...
model_path_T = ['VLE_zeotrope_with_water/T','VLE_azeotrope_with_water/T']
model_name_T = ['Ensemble_0_VLE_zeotrope_with_water_AGCNetVLE2','Ensemble_0_VLE_azeotrope_with_water_AGCNetVLE2']
model_path_Y = ['VLE_zeotrope_with_water/Y','VLE_azeotrope_with_water/Y']
model_name_Y = ['Ensemble_0_VLE_zeotrope_with_water_AGCNetVLE3','Ensemble_0_VLE_azeotrope_with_water_AGCNetVLE3']
