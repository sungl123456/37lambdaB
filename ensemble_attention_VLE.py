...
splitting_seed = [3777,3630]
init_seed = [109,361]
model_num = [30,21]
dataset_list = ['VLE_azeotrope_with_water','VLE_zeotrope_with_water']
path = ['Ensembles/VLE_zeotrope_with_water','Ensembles/VLE_azeotrope_with_water']
path_l = ['Ensembles/Tb_JCIM_normalized/all','Ensembles/Tc_JCIM_normalized/all']
name_l = ['Ensemble_0_Tb_JCIM_normalized_AGCNet','Ensemble_0_Tc_JCIM_normalized_AGCNet']
model_path_T = ['Ensembles/VLE_zeotrope_with_water/T','Ensembles/VLE_azeotrope_with_water/T']
model_name_T = ['Ensemble_0_VLE_zeotrope_with_water_AGCNetVLE2','Ensemble_0_VLE_azeotrope_with_water_AGCNetVLE2']
model_path_Y = ['Ensembles/VLE_zeotrope_with_water/Y','Ensembles/VLE_azeotrope_with_water/Y']
model_name_Y = ['Ensemble_0_VLE_zeotrope_with_water_AGCNetVLE2','Ensemble_0_VLE_azeotrope_with_water_AGCNetVLE2']
...
for j in range(len(dataset_list)):
    ...
    smiles_list_comp1_T, smiles_list_comp2_T  = evaluate_frag_VLE_attention_value(model_T,scaling_T,fetched_data.test_iter, 
                                                                        ...
                                                                        fetched_data.test_smiles_list_comp2,n_param_T)
    
    _, _, test_predict_Y, test_target_Y,\
    attention_comp1_list_Y, attention_comp2_list_Y, \
    smiles_list_comp1_Y, smiles_list_comp2_Y  = evaluate_frag_VLE_attention_value(model_Y,scaling_y1,fetched_data.test_iter, 
                                                                        fetched_data.test_batched_origin_graph_list_comp1, fetched_data.test_batched_origin_graph_list_comp2,
                                                                        fetched_data.test_batched_frag_graph_list_comp1, fetched_data.test_batched_frag_graph_list_comp2,
                                                                        fetched_data.test_batched_motif_graph_list_comp1, fetched_data.test_batched_motif_graph_list_comp2,
                                                                        fetched_data.test_Tb_comp1,
                                                                        ...
                                                                        fetched_data.test_smiles_list_comp1,
                                                                        fetched_data.test_smiles_list_comp2,n_param_Y)
