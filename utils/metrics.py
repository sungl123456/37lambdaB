...
class Metrics_classification(object):
    def __init__(self, y, y_pred):
        super().__init__()
        # self.n = len(y)
        self.score = accuracy_score(y, y_pred)
        self.confusion = self.cfm(y, y_pred)

    def cfm(self, y, y_pred):
        confusion = confusion_matrix(y, y_pred)#tn, fp, fn, tp
        return confusion
