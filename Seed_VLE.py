...
for j in range(len(dataset_list)):
    ...
    for i in range(20):
        ...
        modelT = AGCNetVLE5(net_params).to(device='cpu')
        ...
        modelY = AGCNetVLE6(net_params).to(device='cpu')
        ...
        with tqdm(range(params['max_epoch'])) as t:
            ...
            for epoch in t:
                ...
                start = time.time()
                modelT, epoch_train_loss, epoch_train_metrics  = train_epoch_frag_VLE4(modelT, optimizerT, scaling_T,
                                                                                    ...
                                                                                    n_paramT,lam = 0.3)
                epoch_val_loss, epoch_val_metrics = evaluate_frag_VLE4(modelT, scaling_T, fetched_data.val_iter, 
                                                                                ...
                                                                                n_paramT,lam = 0.3)
                epoch_test_loss, epoch_test_metrics = evaluate_frag_VLE4(modelT, scaling_T, fetched_data.test_iter, 
        ...
        with tqdm(range(params['max_epoch'])) as t:
            ...
            for epoch in t:
                t.set_description('Epoch %d' % epoch)
                start = time.time()
                modelY, epoch_train_loss, epoch_train_metrics  = train_epoch_frag_VLE4(modelY, optimizerY, scaling_y1,
                                                                                            fetched_data.train_iter,
                                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                ...
                epoch_val_loss, epoch_val_metrics = evaluate_frag_VLE4(modelY, scaling_y1, fetched_data.val_iter, 
                                                                                fetched_data.val_batched_origin_graph_list_comp1,
                                                                                fetched_data.val_batched_origin_graph_list_comp2,
                                                                                fetched_data.val_batched_frag_graph_list_comp1, 
                                                                                fetched_data.val_batched_frag_graph_list_comp2,
                ...
                epoch_test_loss, epoch_test_metrics = evaluate_frag_VLE4(modelY, scaling_y1, fetched_data.test_iter, 
                                                                                fetched_data.test_batched_origin_graph_list_comp1,
                                                                                fetched_data.test_batched_origin_graph_list_comp2,
                                                                                fetched_data.test_batched_frag_graph_list_comp1,
                                                                                fetched_data.test_batched_frag_graph_list_comp2,
        ...
        _, epoch_train_T_metrics = evaluate_frag_VLE4(modelT, scaling_T,fetched_data.train_iter,
                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                                                                            fetched_data.train_batched_frag_graph_list_comp2,
                                                                            ...
                                                                            fetched_data.train_Tc_comp2,
                                                                            fetched_data.train_x1,
                                                                            fetched_data.train_T,fetched_data.train_smiles_list_comp1,fetched_data.train_smiles_list_comp2,n_paramT,lam = 0.3)
        _, epoch_val_T_metrics = evaluate_frag_VLE4(modelT,scaling_T,fetched_data.val_iter, 
                                                                            ...
                                                                            fetched_data.val_Tc_comp2,
                                                                            fetched_data.val_x1,
                                                                            fetched_data.val_T,fetched_data.val_smiles_list_comp1,fetched_data.val_smiles_list_comp2,n_paramT,lam = 0.3)
        _, epoch_test_T_metrics = evaluate_frag_VLE4(modelT,scaling_T,fetched_data.test_iter, 
                                                                            ...
                                                                            fetched_data.test_Tc_comp2,
                                                                            fetched_data.test_x1,
                                                                            fetched_data.test_T,fetched_data.test_smiles_list_comp1,fetched_data.test_smiles_list_comp2,n_paramT,lam = 0.3)
        _, epoch_raw_T_metrics = evaluate_frag_VLE4(modelT,scaling_T,fetched_data.all_iter, 
                                                                            fetched_data.all_batched_origin_graph_list_comp1, fetched_data.all_batched_origin_graph_list_comp2,
                                                                            fetched_data.all_batched_frag_graph_list_comp1, fetched_data.all_batched_frag_graph_list_comp2,
                                                                            fetched_data.all_batched_motif_graph_list_comp1, fetched_data.all_batched_motif_graph_list_comp2,
                                                                            ...
                                                                            fetched_data.all_x1,
                                                                            fetched_data.all_T,fetched_data.all_smiles_list_comp1,fetched_data.all_smiles_list_comp2,n_paramT,lam = 0.3)
        
        modelY = early_stoppingY.load_checkpoint(modelY)
        _, epoch_train_Y_metrics = evaluate_frag_VLE4(modelY, scaling_y1,fetched_data.train_iter,
                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                                                                            fetched_data.train_batched_frag_graph_list_comp2,
                                                                            ...
                                                                            fetched_data.train_Tc_comp2,
                                                                            fetched_data.train_x1,
                                                                            fetched_data.train_y1,fetched_data.train_smiles_list_comp1,fetched_data.train_smiles_list_comp2,n_paramY,lam = 0.1)
        _, epoch_val_Y_metrics = evaluate_frag_VLE4(modelY,scaling_y1,fetched_data.val_iter, 
                                                                            fetched_data.val_batched_origin_graph_list_comp1, fetched_data.val_batched_origin_graph_list_comp2,
                                                                            fetched_data.val_batched_frag_graph_list_comp1, fetched_data.val_batched_frag_graph_list_comp2,
                                                                            fetched_data.val_batched_motif_graph_list_comp1, fetched_data.val_batched_motif_graph_list_comp2,
                                                                            fetched_data.val_Tb_comp1,
                                                                            ...
                                                                            fetched_data.val_Tc_comp2,
                                                                            fetched_data.val_x1,
                                                                            fetched_data.val_y1,fetched_data.val_smiles_list_comp1,fetched_data.val_smiles_list_comp2,n_paramY,lam = 0.1)
        _, epoch_test_Y_metrics = evaluate_frag_VLE4(modelY,scaling_y1,fetched_data.test_iter, 
                                                                            fetched_data.test_batched_origin_graph_list_comp1, fetched_data.test_batched_origin_graph_list_comp2,
                                                                            fetched_data.test_batched_frag_graph_list_comp1, fetched_data.test_batched_frag_graph_list_comp2,
                                                                            fetched_data.test_batched_motif_graph_list_comp1, fetched_data.test_batched_motif_graph_list_comp2,
                                                                            fetched_data.test_Tb_comp1,
                                                                            ...
                                                                            fetched_data.test_Tc_comp2,
                                                                            fetched_data.test_x1,
                                                                            fetched_data.test_y1,fetched_data.test_smiles_list_comp1,fetched_data.test_smiles_list_comp2,n_paramY,lam = 0.1)
        _, epoch_raw_Y_metrics = evaluate_frag_VLE4(modelY,scaling_y1,fetched_data.all_iter, 
                                                                            fetched_data.all_batched_origin_graph_list_comp1, fetched_data.all_batched_origin_graph_list_comp2,
                                                                            fetched_data.all_batched_frag_graph_list_comp1, fetched_data.all_batched_frag_graph_list_comp2,
                                                                            fetched_data.all_batched_motif_graph_list_comp1, fetched_data.all_batched_motif_graph_list_comp2,
                                                                            fetched_data.all_Tb_comp1,
                                                                            ...
                                                                            fetched_data.all_Tc_comp2,
                                                                            fetched_data.all_x1,
                                                                            fetched_data.all_y1,fetched_data.all_smiles_list_comp1,fetched_data.all_smiles_list_comp2,n_paramY,lam = 0.1)
