...
for j in range(len(dataset_list)):
    ...
    for i in range(10):
        ...
        model_T = AGCNetVLE2(net_params).to(device='cpu')
        ...
        model_Y = AGCNetVLE3(net_params).to(device='cpu')
        ...
        with tqdm(range(params['max_epoch'])) as t:
            ...
            for epoch in t:
                ...
                start = time.time()
                model_T, epoch_train_loss_T, epoch_train_metrics_T  = train_epoch_frag_VLE(model_T, optimizer_T, scaling_T,
                ...
                epoch_val_loss_T, epoch_val_metrics_T = evaluate_frag_VLE(model_T, scaling_T,
        ...
        with tqdm(range(params['max_epoch'])) as t:
            ...
            for epoch in t:
                t.set_description('Epoch %d' % epoch)
                start = time.time()
                model_Y, epoch_train_loss_Y, epoch_train_metrics_Y  = train_epoch_frag_VLE(model_Y, optimizer_Y, scaling_y1,
                                                                                            fetched_data.train_iter,
                                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                ...
                epoch_val_loss_Y, epoch_val_metrics_Y = evaluate_frag_VLE(model_Y, scaling_y1,
                                                                    fetched_data.val_iter, 
                                                                    fetched_data.val_batched_origin_graph_list_comp1, fetched_data.val_batched_origin_graph_list_comp2,
                                                                    fetched_data.val_batched_frag_graph_list_comp1, fetched_data.val_batched_frag_graph_list_comp2,
                                                                    fetched_data.val_batched_motif_graph_list_comp1, fetched_data.val_batched_motif_graph_list_comp2,
        ...
        _, epoch_train_metrics_T = evaluate_frag_VLE(model_T, scaling_T,fetched_data.train_iter,
                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                                                                            fetched_data.train_batched_frag_graph_list_comp2,
        ...
        _, epoch_val_metrics_T = evaluate_frag_VLE(model_T,scaling_T,fetched_data.val_iter, 
                                                                            fetched_data.val_batched_origin_graph_list_comp1, fetched_data.val_batched_origin_graph_list_comp2,
                                                                            fetched_data.val_batched_frag_graph_list_comp1, fetched_data.val_batched_frag_graph_list_comp2,
                                                                            fetched_data.val_batched_motif_graph_list_comp1, fetched_data.val_batched_motif_graph_list_comp2,
                                                                            fetched_data.val_Tb_comp1,
        ...
        _, epoch_test_metrics_T, predict_test_T, target_test_T, test_T_smiles_comp1, test_T_smiles_comp2 = evaluate_frag_VLE(model_T,scaling_T,fetched_data.test_iter, 
        ...
        _, epoch_raw_metrics_T = evaluate_frag_VLE(model_T,scaling_T,fetched_data.all_iter, 
                                                                            fetched_data.all_batched_origin_graph_list_comp1, fetched_data.all_batched_origin_graph_list_comp2,
                                                                            fetched_data.all_batched_frag_graph_list_comp1, fetched_data.all_batched_frag_graph_list_comp2,
                                                                            fetched_data.all_batched_motif_graph_list_comp1, fetched_data.all_batched_motif_graph_list_comp2,
        ...
        _, epoch_train_metrics_Y = evaluate_frag_VLE(model_Y, scaling_y1,fetched_data.train_iter,
                                                                            fetched_data.train_batched_origin_graph_list_comp1,
                                                                            fetched_data.train_batched_origin_graph_list_comp2,
                                                                            fetched_data.train_batched_frag_graph_list_comp1,
                                                                            fetched_data.train_batched_frag_graph_list_comp2,
                                                                            ...
                                                                            fetched_data.train_smiles_list_comp1,
                                                                            fetched_data.train_smiles_list_comp2,n_param)
        _, epoch_val_metrics_Y = evaluate_frag_VLE(model_Y,scaling_y1,fetched_data.val_iter, 
                                                                            fetched_data.val_batched_origin_graph_list_comp1, fetched_data.val_batched_origin_graph_list_comp2,
                                                                            fetched_data.val_batched_frag_graph_list_comp1, fetched_data.val_batched_frag_graph_list_comp2,
                                                                            fetched_data.val_batched_motif_graph_list_comp1, fetched_data.val_batched_motif_graph_list_comp2,
                                                                            fetched_data.val_Tb_comp1,
                                                                            ...
                                                                            fetched_data.val_smiles_list_comp1,
                                                                            fetched_data.val_smiles_list_comp2,n_param)
        _, epoch_test_metrics_Y, predict_test_Y, target_test_Y, test_Y_smiles_comp1, test_Y_smiles_comp2 = evaluate_frag_VLE(model_Y,scaling_y1,fetched_data.test_iter, 
                                                                            fetched_data.test_batched_origin_graph_list_comp1, fetched_data.test_batched_origin_graph_list_comp2,
                                                                            fetched_data.test_batched_frag_graph_list_comp1, fetched_data.test_batched_frag_graph_list_comp2,
                                                                            fetched_data.test_batched_motif_graph_list_comp1, fetched_data.test_batched_motif_graph_list_comp2,
                                                                            fetched_data.test_Tb_comp1,
        ...
        results = pd.Series({'init_seed': init_seed_list[i],'seed': splitting_seed[j], 
        ...
        comments = ''
        save_model(model_T, path_T, name, params, net_params, results, comments)
        save_model(model_Y, path_Y, name, params, net_params, results, comments)
        ...
        if i == 0 :
            df_test_T = pd.DataFrame({'SMILES_comp1': test_T_smiles_comp1[0], 'SMILES_comp2': test_T_smiles_comp2[0], 'Tag': 'Test', 'Target': target_test_T.numpy().flatten().tolist(),
                                     'Predict_'+str(i): predict_test_T.numpy().flatten().tolist()})
            df_test_Y = pd.DataFrame({'SMILES_comp1': test_Y_smiles_comp1[0], 'SMILES_comp2': test_Y_smiles_comp2[0], 'Tag': 'Test', 'Target': target_test_Y.numpy().flatten().tolist(),
                                     'Predict_'+str(i): predict_test_Y.numpy().flatten().tolist()})
        else:
            df_test_T['Predict_' + str(i)] = predict_test_T.numpy().flatten().tolist()
            df_test_Y['Predict_' + str(i)] = predict_test_Y.numpy().flatten().tolist()
        
        save_file_path_T = os.path.join('./library/' + path_T, '{}_{}_{}_{}'.format(name, 'test_value', init_seed_list[i], time.strftime('%Y-%m-%d-%H-%M')) + '.csv')
        save_file_path_Y = os.path.join('./library/' + path_Y, '{}_{}_{}_{}'.format(name, 'test_value', init_seed_list[i], time.strftime('%Y-%m-%d-%H-%M')) + '.csv')
