# This file is built for azeotropic classification random seed searching
...
for j in range(len(dataset_list)):
    ...
    for i in range(50):
        ...
        t0 = time.time()
        per_epoch_time = []
        early_stopping = EarlyStopping(patience=params['earlystopping_patience'], path='./checkpoint/checkpoint_ensemble_' + params['Dataset'] + '_AGCNet_clf' + '.pt')
