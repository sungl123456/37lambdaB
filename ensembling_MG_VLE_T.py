...
for j in range(len(dataset_list)):
    ...
    with tqdm(range(params['max_epoch'])) as t:
        ...
        for epoch in t:
            ...
            start = time.time()
            model, epoch_train_loss, epoch_train_metrics  = train_epoch_frag_VLE(model, optimizer, scaling_T,
        ...
        path = '/Ensembles/'+ params['Dataset'] + '/MG_T_ensemble'
