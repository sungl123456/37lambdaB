...
model_path = ['Ensembles/zeotrope_VLE/MG_T_ensemble','Ensembles/azeotrope_VLE/MG_T_ensemble']
...
for j in range(len(model_path)):
    ...
    save_file_path = os.path.join('./library/' + path, '{}_{}_{}_{}'.format(name, dataset_list[j], 'T', time.strftime('%Y-%m-%d-%H-%M')) + '.csv')
